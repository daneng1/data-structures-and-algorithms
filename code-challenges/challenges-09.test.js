...
const addValues = (arr) => arr.reduce((answersSoFar, value) => {
...
const addPurchases = (arr) => arr.reduce((answersSoFar, value) => {
  answersSoFar = answersSoFar + value.purchasePrice;
  return answersSoFar;
}, 0
);
...
const countNumberOfElements = (arr) => arr.reduce((answersSoFar,value, idx) => {
  answersSoFar = idx + 1;
  return answersSoFar;
}, 0
);
...
const returnNames = (arr) => 
  arr.reduce((answersSoFar, value, index) => {
    answersSoFar.push(value.name);
    return answersSoFar;
  }, []);
